...
sns_topic_arn = "arn:aws:sns:eu-west-1:482309475018:Leon_Smith-de-mbd-predict-SNS"
user_name = "Leon_Smith"
...
process_script = BashOperator(
	...
	bash_command = f"python3 {MOUNT_DIR}/Scripts/historical_processing_ec2.py",
	dag=dag
)
